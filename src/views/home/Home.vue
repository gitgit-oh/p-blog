        ...
        <div class="home-banner" :style="cover">
            <div class="banner-container">
                ...
                <div class="blog-intro">
                    {{ tempSwiper }}<span class="typed-cursor">|</span>
                </div>
                <!-- 联系方式 -->
                <div class="blog-contact">
                    <a v-if="isShowSocial('qq')" class="mr-5 iconfont iconqq" target="_blank" :href="harf" />
                    <a v-if="isShowSocial('github')" target="_blank" :href="harf" class="mr-5 iconfont icongithub" />
                    <a v-if="isShowSocial('gitee')" target="_blank" :href="harf" class="iconfont icongitee-fill-round" />
                </div>
            </div>
            <!-- 向下滚动 -->
                ...
                <v-card class="animated zoomIn article-card" style="border-radius: 12px 8px 8px 12px"
                    ...
                    <div class="article-wrapper">
                        ...
                        <div class="article-info">
                            ...
                            <span class="separator">|</span>
                            <!-- 文章分类 -->
                            <router-link :to="'/' + item.categoryId">
                                <v-icon size="14">mdi-inbox-full</v-icon>
                                {{ item.categoryName }}
                            </router-link>
                            <span class="separator">|</span>
                            <!-- 文章标签 -->
                            <router-link style="display:inline-block" :to="'/' + tag.id" class="mr-1"
                                v-for="tag of item.tagList" :key="tag.id">
                ...
                <div class="blog-wrapper">
                    <v-card class="animated zoomIn blog-card mt-5">
                        <div class="author-wrapper">
                            <!-- 博主头像 -->
                            <v-avatar size="110">
                                <img class="author-avatar" :src="blogInfo.src" />
                            </v-avatar>
                        ...
                        <div class="card-info-social">
                            <a v-if="isShowSocial('qq')" class="mr-5 iconfont iconqq" target="_blank" :href="href" />
                            <a v-if="isShowSocial('github')" target="_blank" :href="href"
                                class="mr-5 iconfont icongithub" />
                            <a v-if="isShowSocial('gitee')" target="_blank" :href="href"
...
const blogInfo = reactive(blogInfoRef)


const list = [
    {
        id: 1,
        cover: "src/assets/fukralos.png",
        title: "关关雎鸠",
        isTop: true,
...
const talkList = reactive(["偷得浮生半日闲", "不破楼兰终不回", "为伊消得人憔悴"])
...
const cover = computed(() => {
    return "background: url(src/assets/shenli.jpg) center center / cover no-repeat";
})
